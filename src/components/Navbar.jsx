  			...
  			<ul className="flex space-x-4">
  				<li><NavLink style={linkStyle} to="/" className="text-[20px] font-normal hover:text-gray-300">Home</NavLink></li>
  				{
  					...
  					<>
  						...
  						<li className={navItemClass}><NavLink style={linkStyle} to="/add-material" className="text-[20px] font-normal hover:text-gray-300" onClick={logout}>Add material</NavLink></li>
  						<li className={navItemClass}><NavLink style={linkStyle} to="/edit-material/:id" className="text-[20px] font-normal hover:text-gray-300" onClick={logout}>Edit material</NavLink></li>
