        ...
        <link rel="icon" type="image/png" href="/home-icon.png" />
			...
			<div className="grid grid-cols-2">
    			...
    			<div className="text-black text-center content-center">
					...
					{
						adminloading? 
						<button type="submit" className="text-left text-white bg-black hover:bg-white hover:text-black hover:border hover:border-black py-2 px-4 rounded"><ClipLoader color='white' loading={true} size={20}/></button>
						:
